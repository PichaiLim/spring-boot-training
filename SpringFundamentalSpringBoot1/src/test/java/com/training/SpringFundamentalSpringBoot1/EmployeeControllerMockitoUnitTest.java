...
import com.training.SpringFundamentalSpringBoot1.controller.EmployeeController;
...
public class EmployeeControllerMockitoUnitTest {
    ...
    @Mock
    private EmployeeJpsRepository employeeRepository;
...
//        this.controller.setEmployeeRepository(employeeRepository);
    ...
    public void getEmployeesShouldReturnListOfEmployees() throws Exception {
        ...
        BDDMockito.given(employeeRepository.findAllEmployees()).willReturn(employees);
